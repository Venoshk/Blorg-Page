...
export const Footer = () => {
  return (
    <footer className="bg-Footer flex flex-col items-center md:items-start justify-center md:justify-around gap-5 rounded-borderRadiusMobileFooter md:flex-row w-full py-10">
        <div>
            <img src={Logo} alt="" />
        </div>
